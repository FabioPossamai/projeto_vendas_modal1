<!--Modal do cadastro de um novo cliente-->
...
<!--Modal para deletar um cliente-->
<div class="modal fade" aria-hidden="true" role="dialog" tabindex="-1" id="modal-delete-{{$pes->pessoa_id}}">
    <div class="modal-dialog" role="document">
        {!!Form::open(['method' => 'GET', 'url' => '/cliente/'.$pes->pessoa_id.'/destroy','style' =>  'display: inline;'])!!}
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="close">
                    <span aria-hidden="true">x</span>
                </button>
                <h4 class="modal-title">Eleminar Cliente: {{$pes->nome}}</h4>
            </div>
            <div class="modal-body">
...
<div class="modal fade" aria-hidden="true" role="dialog" tabindex="-1" id="modal-edit-{{$pes->pessoa_id}}">
    <div class="modal-dialog" role="document">
        {!!Form::open(['method' => 'put', 'url' => "/cliente/".$pes->pessoa_id.'/update','style' =>  'display: inline;']) !!}
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="close">
                    <span aria-hidden="true">x</span>
                </button>
                <h4 class="modal-title">Editar Cliente: {{$pes->nome}}</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
